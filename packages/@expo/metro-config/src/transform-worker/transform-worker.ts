...
import { fromRawMappings, toBabelSegments, toSegmentTuple } from 'metro-source-map';
...
type MinifierConfig = { [key: string]: any };
...
export type Minifier = (minifier: MinifierOptions) => MinifierResult | Promise<MinifierResult>;
